...
# Changing Months formatting
SNCF_regularite[,2] <- month.abb[SNCF_regularite[,2]]
SNCF_regularite[,2] <- factor(SNCF_regularite[,2], levels = (unique(SNCF_regularite[,2])))
...
Paris_Nantes %>% 
  ...
  geom_bar(aes(fill = Année), stat = "identity")
