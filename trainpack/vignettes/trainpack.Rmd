...
Inspired by the sports betting websites (betfair, pmu, winamax ...), we created a simple display where someone can bet on the delay of a train. We also want to display some facts and useful data to help placing the bet.
