...
my_desc$set("Package", "BetOnTrains")
...
# The urls
my_desc$set("URL", "https://github.com/ThinkR-open/BetOnTrains")
my_desc$set("BugReports", "https://github.com/ThinkR-open/BetOnTrains/issues")
# Save everyting
...
# Vignette
usethis::use_vignette("BetOnTrains")
